# ScanCurDirTargets.cmake
# Reusable function to create targets from .cpp files
# Creates targets with naming pattern: <parent_folder>_<filename>

function(scan_cur_dir_targets)
    # Get parent folder name (e.g., ITSA)
    get_filename_component(PARENT_FOLDER_NAME ${CMAKE_CURRENT_SOURCE_DIR} NAME)
    ...
    foreach(CPP_FILE ${CPP_FILES})
        ...
        # Create target name: <parent>_<filename>
        set(TARGET_NAME "${PARENT_FOLDER_NAME}_${FILE_NAME}")
